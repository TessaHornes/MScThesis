...
# paramA: orientation 
paramA_lookup = {
    'A1': {'a1': {'kappa1': 54.23, 'loc1': 1.54}, 
           'a2': {'kappa2': 26.10, 'loc2': 0.66},
           'a3': {'kappa3': 49.35, 'loc3': 2.64}, 
           'a4': {'kappa4': 37.46, 'loc4': 0.73}},
    'A2': {'a1': {'kappa1': 34.44, 'loc1': 1.52}, 
           'a2': {'kappa2': 16.90, 'loc2': 0.67},
           'a3': {'kappa3': 15.66, 'loc3': 2.61}, 
           'a4': {'kappa4': 11.78, 'loc4': 0.79}},
}
...
for paramA, paramB, paramC, paramD in param_combinations:
    ...
    set_1 = {
        ...
        'fractureLengthPDFParams': c['input'],
